...
const Footer = () => {
  return (
    <footer className="p-20 text-white font-manrope bg-black">
      ...
      <div className="flex justify-between items-center font-manrope mt-10 mx-20 text-gray-400">
        <p className="font-thin w-2/4">
      ...
      <div className="mt-10 font-thin text-gray-400 mx-20">
